...
* Clang: Feature "remove comments from clang preprocessed output" is removed from Octobuild as unsafe (fix #23).
+
To increase cache hit on Unreal Engine build please patch UE4 like https://github.com/EpicGames/UnrealEngine/pull/3014
